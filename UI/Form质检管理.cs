...
namespace UI
{
    public partial class Form质检管理 : Form
    {
        public Form质检管理()
        {
            InitializeComponent();
        ...
        string gdmethod = "";
        string bh = "";
        public Form质检管理(string str, string str2) : this()
        {
            this.lzId = str;
            this.bh = str2;
        }
        ...
        private void Form质检管理_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (n == 0)
            {
                ...
                btn4.Name = "btntc";
                btn4.HeaderText = "图处";
                btn4.DefaultCellStyle.NullValue = "图处";
