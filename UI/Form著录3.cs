...
namespace UI
{
    public delegate void raiseCallBackRefreshDelegate2(); //全局委托申明
    public partial class Form著录3 : Form
    {
        public event raiseCallBackRefreshDelegate2 raiseCallBackRefreshEvent2; //公开的事件
        public Form著录3()
        {
            InitializeComponent();
        }
        ...
        public Form著录3(string str, string str2, string str3) : this()
        {
            //this.pId = str;
            this.bh = str2;
            this.lzId = str3;
